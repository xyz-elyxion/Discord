...
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@plugins/limeyV1Toolbox/menu";
...
export default definePlugin({
    ...
    patches: [
            ...
            replacement: [
                {
                    ...
                    replace: "var $1=$self.Layer;class LimeyV1PatchedOldFadeLayer$2",
        ...
        { // Load menu TOC eagerly
            ...
            replacement: {
                ...
                replace: "_limeyV1BetterSettingsEagerLoad=(async ()=>$1)();"
            },
            predicate: () => settings.store.eagerLoad
        },
    ...
    Layer(props: LayerProps) {
        try {
            [FocusLock.$$limeyV1GetWrappedComponent(), ComponentDispatch, Classes.layer].forEach(e => e.test);
        } catch {
    ...
    transformSettingsEntries(list: ReactElement<any>[]): ReactNode[] {
        ...
        for (const item of list) {
            ...
            if (key === "limeyV1_plugins" || key === "limeyV1_themes") {
                const children = key === "limeyV1_plugins"
