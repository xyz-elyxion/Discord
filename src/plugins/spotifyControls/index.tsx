...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                // react.jsx(WrapperComponent, { LimeyV1Original: AccountPanel, ...
                replace: "$self.PanelWrapper,{LimeyV1Original:$1,"
            }
        },
        {
            find: ".PLAYER_DEVICES",
    ...
    PanelWrapper({ LimeyV1Original, ...props }) {
        return (
            <>
                <ErrorBoundary
                    fallback={() => (
