...
import type { Channel, Role } from "@limeyV1/discord-types";
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel, permCheck) => `${m}!LimeyV1.Webpack.Common.PermissionStore.can(${CONNECT}n,${channel})?${permCheck}CONNECT):`
                },
                {
