...
function LimeyV1ChatBarButtons(props: ChatBarProps) {
...
export function _injectButtons(buttons: ReactNode[], props: ChatBarProps) {
    ...
    buttons.unshift(<LimeyV1ChatBarButtons key="limeyV1-chat-buttons" {...props} />);
}
...
addContextMenuPatch("textarea-context", (children, args) => {
    ...
    group.splice(idx, 0,
        <Menu.MenuItem id="vc-chat-buttons" key="limeyV1-chat-buttons" label="Limey V1 Buttons">
            {buttons.map(([id]) => (
