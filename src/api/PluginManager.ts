...
import { FluxEvents } from "@limeyV1/discord-types";
...
export function addPatch(newPatch: Omit<Patch, "plugin">, pluginName: string, pluginPath = `LimeyV1.Plugins.plugins[${JSON.stringify(pluginName)}]`) {
