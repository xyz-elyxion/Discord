...
import { gitRemote } from "@shared/limeyV1UserAgent";
        ...
        <SettingsTab>
            {isDonor(user?.id)
                ...
                : (
                    <SpecialCard
                        ...
                        description="Please consider supporting the development of Limey V1 by donating!"
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Limey V1 you now have a cool new badge!"
                    ...
                    {!IS_WEB && (
                        <>
                            ...
                            <QuickAction
                                ...
                                action={() => LimeyV1Native.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => LimeyV1Native.native.openExternal("https://github.com/" + gitRemote)}
                    />
                </QuickActionCard>
            </section>
...
export default wrapTab(LimeyV1Settings, "Limey V1 Settings");
