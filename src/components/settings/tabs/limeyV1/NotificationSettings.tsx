    ...
    return (
        <section className={Margins.top16}>
            ...
            <Forms.FormText className={Margins.bottom8}>
                Settings for Notifications sent by LimeyV1.
    ...
    return (
        <>
            ...
            <Forms.FormText className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>Limey V1 Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: "Always use Limey V1 notifications", value: "never" },
