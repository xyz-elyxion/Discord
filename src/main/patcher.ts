...
console.log("[Limey V1] Starting up...");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Limey V1");
} else {
    console.log("[Limey V1] Running in vanilla mode. Not loading Limey V1");
}

console.log("[Limey V1] Loading original Discord app.asar");
