...
![](https://img.shields.io/github/package-json/v/xyz-elyxion/Discord?style=for-the-badge&logo=github&logoColor=d3869b&label=&color=1d2021&labelColor=282828)
...
-   Easy to install
-   [100+ built in plugins](https://limeyV1.dev/plugins)
...
Visit https://limeyV1.dev/download
...
|     **Thanks a lot to all Limey V1 [sponsors](https://github.com/xyz-elyxion)!!**     |
| :------------------------------------------------------------------------------------------: |
|   [![](https://meow.xyz-elyxion.dev/sponsors.png)](https://github.com/xyz-elyxion)    |
| *generated using [github-sponsor-graph](https://github.com/xyz-elyxion/github-sponsor-graph)* |


## Star History

<a href="https://star-history.com/#xyz-elyxion/Discord&Timeline">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=xyz-elyxion/Discord&type=Timeline&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=xyz-elyxion/Discord&type=Timeline" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=xyz-elyxion/Discord&type=Timeline" />
  </picture>
</a>
